...
<div class="container mx-auto px-4 py-8 mt-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="mb-4">
                <h2 class="fs-3 fw-bold text-dark mt-2 mb-1">Pilih Tanggal & Lokasi Acara</h2>
                <p class="text-muted">Silakan tentukan tanggal acara dan metode pengambilan pesanan katering Anda.</p>
            </div>
