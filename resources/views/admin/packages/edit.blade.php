...
<div class="max-w-3xl">
    <form action="{{ route('admin.packages.update', $package) }}" method="POST" class="bg-white rounded-xl p-6 shadow-sm border space-y-5" id="packageForm">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div><label class="block text-sm font-medium mb-1">Harga Paket (Rp) *</label><input type="number" name="price" required value="{{ old('price', $package->price) }}" class="w-full px-4 py-2 rounded-lg border"></div>
