...
<div class="row">
    <div class="col-md-8">
        ...
        <form action="{{ route('admin.paket_katering.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" required value="{{ old('name') }}" class="form-control" placeholder="Nama Paket">
