                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.shipping.edit', $s) }}" class="btn btn-sm btn-warning"><i class="fa-solid fa-edit"></i> Edit</a>
                                        <form action="{{ route('admin.shipping.destroy', $s) }}" method="POST" class="d-inline" onsubmit="event.preventDefault(); confirmDeleteForm(this);">
                                            @csrf @method('DELETE')
