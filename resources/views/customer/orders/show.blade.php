...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <a href="{{ route('customer.pesanan') }}" class="d-inline-d-flex align-items-center fs-6 text-primary hover:text-primary mb-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            @if($pesanan->status === 'selesai' && !$pesanan->ulasan)
                <div class="card shadow-sm mb-4 p-4">
                    ...
                    <form action="{{ route('customer.ulasan.store') }}" method="POST" class="d-flex flex-column gap-3">
                        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="card shadow-sm mb-4 p-4">
                ...
                @if(in_array($pesanan->status, ['menunggu_pembayaran', 'diproses']))
                    <form id="cancelOrderForm" action="{{ route('customer.pesanan.cancel', $pesanan) }}" method="POST" class="d-none">
                        @csrf @method('PUT')
