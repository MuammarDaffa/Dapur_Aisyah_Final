...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="rounded-2xl p-8 mb-8 text-white">
        ...
        <a href="{{ route('customer.produk') }}" class="d-inline-d-flex align-items-center mt-4 px-6 py-2.5 bg-white text-primary fw-bold rounded-pill hover:shadow">
    ...
    <div class="bg-white rounded shadow-sm border border border-secondary">
        <div class="p-6 border-b border border-secondary d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('customer.pesanan') }}" class="d-inline-d-flex align-items-center fs-6 text-primary hover:text-primary fw-medium">
        ...
        <div class="divide-y divide-gray-100">
            @forelse($recentOrders as $pesanan)
                <a href="{{ route('customer.pesanan.show', $pesanan) }}" class="d-flex align-items-center justify-content-between p-4 hover:bg-primary text-white/50">
            ...
            @empty
                <div class="p-8 text-center text-secondary">
                    ...
                    <p>Belum ada pesanan. <a href="{{ route('customer.produk') }}" class="text-primary fw-medium hover:underline">Pesan sekarang</a></p>
                </div>
            @endforelse
        </div>
    </div>
