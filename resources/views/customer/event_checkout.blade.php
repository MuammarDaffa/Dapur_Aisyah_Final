                        ...
                        <div id="eventAddressSection" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="district_id" id="eventDistrict" class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:border-orange-400" onchange="loadEventVillages(); loadEventShippingCost();">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                                ...
                                <p class="text-xs text-blue-600">Pembayaran event wajib melalui transfer bank via Midtrans.</p>
                            </div>
